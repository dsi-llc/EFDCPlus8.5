...
# -- setup Breathe integration with readthedocs
...
html_logo = '_images/eems-logo-80px.png'
html_title = "EFDC+ Documentation"
# The theme to use for HTML and HTML Help pages.  See the documentation for
# a list of builtin themes.
#
html_theme = "sphinx_rtd_theme"
html_theme_path = [sphinx_rtd_theme.get_html_theme_path()]
print ('html theme path', html_theme_path)
...
man_pages = [
    (master_doc, 'E', u'EFDC+ Documentation',
     [author], 1)
]
...
# run pdftolatex conversion

# os.system('pdftolatex '+ latex_file_name )
